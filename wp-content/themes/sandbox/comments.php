...
<div id="comments" class="comments-area form-floating">
    ...
    $comments_args = array(
        ...
        'comment_field' => '<p class="comment-form-comment form-floating"><textarea id="comment" class="form-control" name="comment" cols="35" rows="8" aria-required="true" placeholder="'. esc_attr__( 'Comment*', 'sandbox' ) .'" required></textarea><label>Comment *</label></p>',
        ...
        'fields'        => apply_filters( 'comment_form_default_fields', array(
            'author' =>
                ...
                '" size="30" placeholder="'. esc_attr__( 'Name*', 'sandbox' ) .'" required /><label for="c-name">Name *</label></p>',
            ...
            'email' =>
                ...
                '" size="30" placeholder="'. esc_attr__( 'Email*', 'sandbox' ) .'" required /><label for="c-name">Email *</label></p>',
        )),
